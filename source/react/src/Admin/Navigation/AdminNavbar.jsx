    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + isLargeScreen, backgroundColor: 'rgb(0, 0, 22)' }}>
        <Toolbar>
          ...
          <Avatar alt="Zosh" src="https://scontent.fbom65-1.fna.fbcdn.net/v/t39.30808-6/304862858_502474698551906_2585509840550039008_n.png?_nc_cat=106&ccb=1-7&_nc_sid=efb6e6&_nc_ohc=3djNh6WyYWgAX_fj9ST&_nc_ht=scontent.fbom65-1.fna&oh=00_AfCqX1JjV9UOS9Qg6j42ZY40JaSpy-WpYRyj8Yq8rufC3Q&oe=65DC39F2" />
          <Search>
            <SearchIconWrapper>
              <SearchIcon />
            </SearchIconWrapper>
