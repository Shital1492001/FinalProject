        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6} sm={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value="breeds">Cats Breeds</MenuItem>
                <MenuItem value="breed">Dogss Breeds</MenuItem>
                <MenuItem value="accessories">Accessories</MenuItem>
                <MenuItem value="food">Cats Food</MenuItem>
                <MenuItem value="dog_food">Dogs Food</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={6} sm={4}>
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value="maine_coon">Maine Coon</MenuItem>
