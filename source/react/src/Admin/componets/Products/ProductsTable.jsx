        ...
        <Grid container spacing={2}>
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value={"golden_retrievers"}>Golden Retriever</MenuItem>
                <MenuItem value={"dry_food"}>Dogs Dry Food</MenuItem>
                <MenuItem value={"ragdoll"}>RagDoll</MenuItem>
                <MenuItem value={"catcollars"}>Cats Collars</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={4}>
